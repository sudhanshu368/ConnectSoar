...
public class Meeting {
    ...
    public Meeting(String id, String organizationId, String title, String description, String hostId,
                   MeetingStatus status, LocalDateTime scheduledAt, LocalDateTime startedAt,
                   LocalDateTime endedAt, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.organizationId = organizationId;
        this.title = title;
        this.description = description;
        this.hostId = hostId;
        this.status = status != null ? status : MeetingStatus.scheduled;
    ...
    public static class Builder {
        ...
        public Meeting build() {
            return new Meeting(id, organizationId, title, description, hostId, status, scheduledAt, startedAt, endedAt, createdAt, updatedAt);
        }
    }
